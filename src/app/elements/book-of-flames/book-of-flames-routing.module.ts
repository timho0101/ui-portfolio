...
import { DoubleLazyLoadingComponent } from './double-lazy-loading/double-lazy-loading.component';
...
const routes: Routes = [
  {
    path: '',
    component: BookOfFlamesComponent , children: [
      // {path: 'testLazyLoading', component: DoubleLazyLoadingComponent}
